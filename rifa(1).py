...
Valor por número: {self.precoNumero}''')
  ...
  def calcularLucro(self): #Calcula o lucro da rifa com base no preço do número e na quantidade de números vendidos
      lucro = self.precoNumero * len(self.numerosVendidos)
      print(f"Lucro da rifa: {lucro}")
